...
public partial class GnberpContext : DbContext
{
    public GnberpContext()
    {
    }

    public GnberpContext(DbContextOptions<GnberpContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("host=97.74.83.143;database=GNBERP;username=gnb;password=gnb2023", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.34-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Candidate>(entity =>
        {
            ...
            entity.Property(e => e.Accomdation).HasColumnName("accomdation");
            ...
            entity.Property(e => e.Notif1).HasColumnName("notif1");
            entity.Property(e => e.Notif2).HasColumnName("notif2");
            entity.Property(e => e.Notif3).HasColumnName("notif3");
